...
func TestDefaultRegistry_ContainsCanonicalContracts(t *testing.T) {
	...
	required := []string{
		...
		ContractAPILSPPositionRequest,
		ContractAPILSPDiagnosticsResult,
		ContractAPILSPSymbolsResult,
		ContractAPILSPHoverResult,
		ContractAPILSPDefinitionResult,
		ContractAPILSPReferencesResult,
		ContractAPILSPCompletionsResult,
		ContractAuditEvent,
